                  ...
                  Expanded(
                    child: Column(
                      children: [
                        ...
                        if (_compilationErrors.isNotEmpty)
                          _buildErrorsPanel(isDark, cs),
                      ],
                    ),
                  ),
                ],
          ...
          if (_focusedProcName == null) ...[
            Tooltip(
              ...
              child: PopupMenuButton<String>(
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              widget.sourceAmbiente.toUpperCase(),
                              style: TextStyle(
                                fontSize: 10,
                                color: AmbienteSelector.colorForAmbiente(
                                  widget.sourceAmbiente,
                ...
                onSelected: (v) => _openEditDialog(isSource: v == 'src'),
              ),
            ),
            _vSep(divColor),
          ],
